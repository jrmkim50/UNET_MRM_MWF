...
stats = np.load("stats_20_10_split_32_te.npy")
...
weight = 0
model = unet3d_tuning(0.001, n_classes = 1, in_channels = 32).float()
...
if (CHECKPOINT):
    trainer = Trainer(max_epochs=300, gpus=[1], logger=logger,
